...
export default async function HomeProduct() {
  ...
  return (
    <>
     <section className=" z-10 text-white bg-gradient-to-r from-mainRed via-mainRed to-main_orange">
    
        <div className='text-center'>

    <h2 className='text-white lg:text-5xl text-3xl p-2 text-center mb-10 font-bold uppercase bg-gradient-to-l inline-block   from-main_orange'>Collection</h2>
        </div>
   
<div className="grid grid-cols-12 lg:gap-8 gap-3 lg:mx-20 mx-4 pb-10">
